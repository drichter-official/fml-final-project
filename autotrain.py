...
#  python main.py play --agents task1 --no-gui --train 1 --scenario coin-heaven --n-rounds 100
# python main.py play --agents task1 --train 0 --scenario coin-heaven --n-rounds 10
import sys
import gc
