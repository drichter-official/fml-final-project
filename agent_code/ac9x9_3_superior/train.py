...
import agent_code.ac9x9_3_superior.Setting as S 
...
def setup_training(self):
    ...
    if S.LOADCHECKPOINT and os.path.exists('model'):
         ...
         #self.model_ref.load_weights("C:/Users/danie/Meine Ablage/Github/bomberman_rl/agent_code/ac9x9_1_superior/BestCheck/checkpoint-eps_5000-rew_59.0-1")
