...
def setup(self):
    ...
    if S.LOADCHECKPOINT and os.path.exists('model') and not self.train:
        ...
        self.model1 = tf.keras.models.load_model('model', compile=False)
       # self.model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.0001, clipnorm=1.0),loss=tf.keras.losses.Huber())
        ...
        self.model.load_weights("C:/Users/danie/Meine Ablage/Github/bomberman_rl/agent_code/ac9x9_2/Checkpoints/checkpoint-eps_1800-rew_44.5-1")
