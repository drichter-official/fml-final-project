...
import agent_code.ac9x9_1.Setting as S 
...
def setup_training(self):
    ...
    if S.LOADCHECKPOINT:
        ...
        self.model_ref.load_weights(ckptpath)
...
def end_of_round(
    ...
    if self.checkpointcounter % 200 == 0:
        ...
        self.model_ref.save_weights(f'Checkpoints/ckpt-{int(self.checkpointcounter/200)}-rew_{avreward:.1f}')
