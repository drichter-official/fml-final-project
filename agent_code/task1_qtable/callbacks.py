...
def setup(self):
    ...
    self.epsilon_decay = 0.999 #  decay by .5% every episode => 1000 epsiodes = approx .6% random
...
#     near_coin_dir = 0
#     if nearest_coin_rel[0] > 0 and nearest_coin_rel[1] > 0:
#         near_coin_dir = 0
#     elif nearest_coin_rel[0] < 0 and nearest_coin_rel[1] > 0:
#         near_coin_dir = 1
#     elif nearest_coin_rel[0] > 0 and nearest_coin_rel[1] < 0:
#         near_coin_dir = 2
#     elif nearest_coin_rel[0] < 0 and nearest_coin_rel[1] < 0:
#         near_coin_dir = 3
#     
#     UP = game_state["field"][ownpos[0],ownpos[1]-1]
#     DOWN = game_state["field"][ownpos[0],ownpos[1]+1]
#     LEFT = game_state["field"][ownpos[0]+1,ownpos[1]]
#     RIGHT = game_state["field"][ownpos[0]-1,ownpos[1]]
# =============================================================================
    
    mod_pos = [game_state["self"][3][0] % 2, game_state["self"][3][1] % 2]
    return np.concatenate((nearest_coin_rel, mod_pos))
