...
def setup(self):
    ...
    self.epsilon = S.EPSILON_START# start with xx% random exploration
    self.epsilon_min = S.EPSILON_MIN # while training explore at  least  xx% of steps
    self.epsilon_decay = S.EPSILON_DECAY
    
    self.epsilon_imitate = S.EPSILON_IMITATE # percentage of random moves which get imitated
    self.epsilon_imitate_decay = S.EPSILON_IMITATE_DECAY # reduce that overtime
    ...
    if S.LOADCHECKPOINT:
        ...
        self.model.load_weights("C:/Users/danie/Meine Ablage/Github/bomberman_rl/agent_code/ac9x9_superior_gen3/BestCheck/checkpoint-eps_4800-rew_51.9-1")
        #self.model.load_weights("C:/Users/danie/Meine Ablage/Github/bomberman_rl/agent_code/ac9x9_superior_gen3/BestCheck/checkpoint-eps_5000-rew_59.0-1")
        #self.model.load_weights("C:/Users/danie/Meine Ablage/Github/bomberman_rl/agent_code/ac9x9_superior_gen3/BestCheck/checkpoint-eps_12200-rew_53.7-1")
